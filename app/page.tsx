...
const DynamicTextarea = () => {
  ...
  return (
    ...
    <div className='flex h-screen w-screen justify-center'>
      ...
      <div className='bg-black h-20'>hey</div>
      <div className='bg-black h-20'>hey</div>
      <div className='bg-black h-20'>hey</div> <div className='bg-black h-20'>hey</div>
      <div className='bg-black h-20'>hey</div>
      <div className='bg-black h-20'>hey</div>
      <div className='bg-black h-20'>hey</div>
      <div className='bg-black h-20'>hey</div>
      ...
      :
      // <div className='bg-white text-blue h-full fixed z-100 start-0'> 
...
{conversation.map((d)=>{
  ...
  <div className='w-full h-px bg-gray-300 rounded-md mt-4 mb-4'></div>
     ...
     <textarea
      ...
      className="w-full p-2 border border-gray-300 rounded resize-none outline-none overflow-scroll text-black max-h-32 w-1/2 border-2"
      onChange={((e)=>{
